...
import { GiCrossedSwords } from 'react-icons/gi'; // Requires react-icons/gi, if unavailable I'll stick to Fa
...
const PlayersBattle = () => {
    ...
    const handleSubmit = () => {
        ...
        console.log("Starting Battle:", { crownHolder, challenger });
        alert(`Battle Started!\n${crownHolder.name} VS ${challenger.name}`);
        setIsOpen(false);
    ...
    return (
        <div className="players-battle-container">
            <button
                className="start-battle-btn"
                onClick={() => setIsOpen(true)}
            >
                <GiCrossedSwords size={24} />
                Start Players Battle
            </button>
